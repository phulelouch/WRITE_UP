...
{
  header("Location: /?page=home");die("ÃH NÃU!!");
  ob_end_flush();
}
...
?>
			...
			<div style="margin-top: 200px; ">
				...
				<div style="height: 60px"><a  onmouseover="big()" onmouseout="normal()" id=demo   style="color: white; font-size: 40px;text-decoration: none" href="./?page=gifts">Your Gifts!</a></div>
				<?php $_SESSION['name']="children";?>
				<br>
				<br>
